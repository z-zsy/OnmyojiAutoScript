...
class KekkaiActivationAssets: 
	...
	# ocr_check_card_number 
	O_CHECK_CARD_NUMBER = RuleOcr(roi=(477,159,510,480), area=(477,159,510,480), mode="Single line", method="Default", keyword="", name="a_check_card_number")
...
KekkaiActivationSelfAssets = KekkaiActivationAssets
